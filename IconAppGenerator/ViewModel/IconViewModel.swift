                ...
                do {
                    ...
                    if let pickedImage = self.pickedImage {
                        self.iconSizes.forEach { size in
                            ...
                            // So each image will be like 20.png, 30.png...
                        ...
                        DispatchQueue.main.async {
                            ...
                            // Saved Alert
                            self.alertMsg = "Набор иконок успешно сгенерирован!"
                            self.showAlert = true
                        }
                    }
                } catch {
...
// MARK: Extending NS Image to resize the Image with new Size
extension NSImage {
    func resizeImage(size: CGSize) -> NSImage {
        
        // Reducing Scale Factor
